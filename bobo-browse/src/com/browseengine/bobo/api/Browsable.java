...
public interface Browsable extends Searchable
{
	...
	SortCollector getSortCollector(SortField[] sort,Query q,int offset,int count,boolean fetchStoredFields,boolean fetchStoredValue,Set<String> termVectorsToFetch,boolean forceScoring, String groupBy, int maxPerGroup, boolean collectDocIdCache);
